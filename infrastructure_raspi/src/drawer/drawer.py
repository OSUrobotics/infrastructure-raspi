...
# Author: Ryan Roberts, Luke Strohbehn
# TODO: update GPIO to this library: https://abyz.me.uk/rpi/pigpio/python.html
...
class Drawer:
    def __init__(self):
        ...
        self.reset_speed = 0.001 # seconds
        ...
        # TODO: Fix this part
        self.fric_steps = 0.0007 #relation between friction to # of motor steps
        self.fric_speed = .000001 #seconds
        self.fric_min_steps = 15000 # min steps it takes to get brake to touch drawer
        self.base_friction = 0.5 #minimum resistance drawer has (in kg)
    ...
    def set_friction(self):
        """ Set the friction motor resistance """
        self.fric_motor.step(
            num_steps = self.__resistance_steps,
            direction = self.fric_motor.CW,
            speed = self.fric_speed
        )
    ...
    def reset_friction(self):
        """ Unset the friction motor resistance """
        self.fric_motor.step(
            num_steps = self.__resistance_steps,
            direction = self.fric_motor.CCW,
            speed = self.fric_speed
        )
        return
